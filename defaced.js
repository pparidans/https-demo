...
simpleselect = {};
//<img id="logo" src="/images/logo.svg" alt="node.js">
simpleselect.query = '.bien-a-la-une-bigprice, .bien-a-la-une-price, .bien-a-la-une-price-terrains';
simpleselect.func = function (node) {
    ...
    stm.on('end', function() {
      ...
      var bunny = '<img id="logo" src="http://i293.photobucket.com/albums/mm64/xinxinshan/emoticon-bunny.gif" alt="bunny" width="16" height="26">';
      tag = tag.replace(/€/gi, bunny)
      tag = tag.replace(/&euro;/gi, bunny)

      process.stdout.write('changed:   ' + tag + '\n');
